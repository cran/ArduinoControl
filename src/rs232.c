...
/* This file is modified by Gianmarco Polotti on January 23, 2015 with the purpose to make
   it compatible to the use of a dll or so library.
   Changes are minimal and relate to external printing. The original code is maintaind and
   commented.
